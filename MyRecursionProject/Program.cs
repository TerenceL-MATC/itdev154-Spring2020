        ...
        static void AppOperations(int choice)
        {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    WriteLine($"{n1}! is {Recursive.Factorial(n1)}.");
                    break;
                case 2:
                    Write("Enter a integer: ");
                    ...
                    Write($"In Binary: ");
                    Recursive.ConvertBase(n1, 2);
                    Write('\n');
                    Write($"In Octal: ");
                    Recursive.ConvertBase(n1, 8);
                    Write('\n');
                    Write($"In Hexadecimal: ");
                    Recursive.ConvertBase(n1, 16);
                    Write('\n');
                    break;
                case 3:
                    ...
                    WriteLine($"The GCD of {n1} and {n2} is {Recursive.GCD(n1, n2)}.");
                    break;
                case 4:
